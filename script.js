...
// event listener to hide the alert banner when 'x' is clicked
...
let trafficData = {
    ...
    datasets: [{
        data: [750, 1250, 1000, 2000, 1500, 1750, 1250, 1750, 2250, 1500,
    2500],
...
//data for the mobile users doughnut chart
const mobileData = {
